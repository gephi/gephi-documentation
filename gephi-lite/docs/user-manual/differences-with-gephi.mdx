...
- The user interface would not be the exact same (in a good way, because web technologies are easier than the current Java Gephi stack for custom user interfaces development)
...
Please read the [GitHub Integration documentation](./github-auth.md) to know more.
...
Please read the [Custom scripts documentation](./custom-scripts.md) to know more.
...
Please read the [Experimental features documentation](./experimental.md) to know more.
